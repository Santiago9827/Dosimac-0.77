// como podría mejorar la estética del drawer para que sea mas bonito y profesional y que se entrada mejor sobre todo en el apartado de arriba siguiente operación
...
//                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
//                   <Icon name="walk-outline e" size={20} color="#0f172a" />
